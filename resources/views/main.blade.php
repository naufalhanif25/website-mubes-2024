@if ($agent->isDesktop())
    ...
    <body class="main">
        <div class="container mt-5">
            <div class="typewriter-animation" style="animation: typing1 5s steps(16, end) forwards, blink-caret .9s infinite;">
                <h1>SELAMAT DATANG</h1>
            </div>
        </div>
        <!-- <div class="box">
            <img src="/img/floating_boy.png" alt="" class="boy">
            <img src="/img/clock.png" alt="" class="clock">
            <img src="/img/gear.png" alt="" class="gear1">
            <img src="/img/gear.png" alt="" class="gear2">
        </div> -->
        <!-- <div class="text">
            <div class="hp">
                <h2>DESKRIPSI</h2>
