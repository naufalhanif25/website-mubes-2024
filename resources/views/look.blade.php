@if ($agent->isDesktop())
    ...
    <body class="vote">
        ...
        <div style="width: 82vh; justify-content: center; align-items: center;">
            <div class="text_v" style="position: relative; display: flex; animation: typing1 2s steps(8, end) forwards, blink-caret 1s infinite; left: 54vh; top: 8vh">
    ...
    <body class="vote" style="overflow-x: hidden">
        ...
        <div style="display: flex; position: relative; margin: 0">
            ...
            <div class="footer_icon" style="top: 0; margin: 0; bottom: 0">
                ...
                <p class="footer_t" style="top: 0; margin: 0; padding: 0; top: 2.2vh; left: 2vw">Copyright @ Himpunan Mahasiswa Informatika 2024. All Rights Reserved</p>
            </div>  
        </div>
    </body>
    </html>
